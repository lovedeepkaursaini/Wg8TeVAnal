...
#ifdef skimmer_wg_cxx
skimmer_wg::skimmer_wg(TString fileName) : fChain(0) 
{
...
skimmer_wg::~skimmer_wg()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t skimmer_wg::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t skimmer_wg::LoadTree(Long64_t entry)
{
...
void skimmer_wg::Init(TTree *tree)
{
...
void skimmer_wg::Show(Long64_t entry)
{
...
Int_t skimmer_wg::Cut(Long64_t entry)
{
