...
double skimmer_wg::dR(double eta1, double phi1, double eta2, double phi2) {
  double dphi = acos(cos(phi1 - phi2));
  double deta = eta1 - eta2;
  return sqrt(dphi*dphi + deta*deta);
}

bool skimmer_wg::fidEtaPass(double Eta){
...
int skimmer_wg::phoRegion(double absEta){
  int region = 0;
